          ...
          <div class="card-body mx-2 my-3">
            ...
            <form action="<?= base_url('admin/kelas/tambahKelasPost'); ?>" method="post">
              ...
              <div class="col-8">
                ...
                <input type="text" id="kelas" class="text-light form-control <?= invalidFeedback('kelas') ? 'is-invalid' : ''; ?>" name="kelas" placeholder="Contoh: X TKJ 1" , value="<?= old('kelas') ?>" required>
