               ...
               <div class="card-body mx-2 my-3">
                  ...
                  <form action="<?= base_url('admin/siswa/create'); ?>" method="post">
                     ...
                     <div class="form-group mt-4">
                        ...
                        <input type="text" id="nis" class="text-light form-control <?= $validation->getError('nis') ? 'is-invalid' : ''; ?>" name="nis" placeholder="Nomor Induk Siswa Nasional" value="<?= old('nis') ?? $oldInput['nis']  ?? '' ?>" required>
                     ...
                     <div class="form-group mt-4">
                        ...
                        <input type="text" id="nama" class="text-light form-control <?= $validation->getError('nama') ? 'is-invalid' : ''; ?>" name="nama" placeholder="Nama Siswa" value="<?= old('nama') ?? $oldInput['nama']  ?? '' ?>" required>
                        <div class="invalid-feedback">
                     ...
                     <div class="row">
                        <div class="col-md-6">
                           ...
                           <select class="text-dark custom-select <?= $validation->getError('id_kelas') ? 'is-invalid' : ''; ?>" id="kelas" name="id_kelas">
                     ...
                     <div class="form-group mt-5">
                        ...
                        <input type="number" id="hp" name="no_hp" class="text-light form-control <?= $validation->getError('no_hp') ? 'is-invalid' : ''; ?>" placeholder="08**********" value="<?= old('no_hp') ?? $oldInput['no_hp'] ?? '' ?>">
                        <div class="invalid-feedback">
