               ...
               <div class="card-body mx-2 my-3">
                  ...
                  <form action="<?= base_url('admin/siswa/edit'); ?>" method="post">
                     ...
                     <div class="form-group mt-4">
                        ...
                        <input type="text" id="nis" class="text-light form-control <?= $validation->getError('nis') ? 'is-invalid' : ''; ?>" name="nis" placeholder="Nomor Induk Siswa Nasional" value="<?= old('nis') ?? $oldInput['nis'] ?? $data['nis'] ?>">
                     ...
                     <div class="form-group mt-4">
                        ...
                        <input type="text" id="nama" class="text-light form-control <?= $validation->getError('nama') ? 'is-invalid' : ''; ?>" name="nama" placeholder="Nama Siswa" value="<?= old('nama') ?? $oldInput['nama'] ?? $data['nama_siswa'] ?>">
                        <div class="invalid-feedback">
                     ...
                     <div class="form-group mt-5">
                        ...
                        <input type="number" id="hp" name="no_hp" class="text-light form-control <?= $validation->getError('no_hp') ? 'is-invalid' : ''; ?>" placeholder="08**********" value="<?= old('no_hp') ?? $oldInput['no_hp'] ?? $data['no_hp'] ?>">
                        <div class="invalid-feedback">
