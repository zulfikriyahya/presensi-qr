                     ...
                     <div class="col-xl-6 col-lg-6 col-md-6 col-xs-6">
                        <div class="card bg-dark h-100">
                           <form action="<?= base_url('admin/laporan/siswa'); ?>" method="post" class="card-body d-flex flex-column">
                              <h4 class="text-light"><b>Laporan Presensi Siswa</b></h4>
                              <div class="row align-items-center">
                                 <div class="col-auto">
                                    <p class="d-inline"><b>Bulan :</b></p>
                                 </div>
                                 <div class="col-5">
                                    <input type="month" name="tanggalSiswa" id="tanggalSiswa" class="text-light form-control" value="<?= date('Y-m'); ?>">
                                 </div>
                              </div>
                              ...
                              <div class="mt-auto d-flex flex-column">
                                 ...
                                 <button type="submit" name="type" value="doc" class="btn btn-info pl-3">
                                    <div class="row align-items-center">
                                       ...
                                       <div class="col">
                                          <div class="text-start">
                                             <h4 class="d-inline"><b>Generate docx</b></h4>
                                          </div>
                                       </div>
                                    </div>
                                 </button>
                     ...
                     <div class="col-xl-6 col-lg-6 col-md-6 col-xs-6">
                        <div class="card bg-dark h-100">
                           <form action="<?= base_url('admin/laporan/guru'); ?>" method="post" class="card-body d-flex flex-column">
                              <h4 class="text-light"><b>Laporan Presensi Guru</b></h4>
                              <p>Total Guru & Staf : <b><?= count($guru); ?> Orang</b></p>
                              <div class="row align-items-center">
                                 <div class="col-auto">
                                    <p class="d-inline"><b>Bulan :</b></p>
                                 </div>
                                 <div class="col-5">
                                    <input type="month" name="tanggalGuru" id="tanggalGuru" class="text-light form-control" value="<?= date('Y-m'); ?>">
                                 </div>
                              </div>
                              <div class="mt-auto d-flex flex-column">
                                 <button type="submit" name="type" value="pdf" class="btn btn-danger pl-3">
