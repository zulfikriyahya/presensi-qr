          ...
          <div class="card-body mx-2 my-3">
            ...
            <form action="<?= base_url('admin/jurusan/tambahJurusanPost'); ?>" method="post">
              ...
              <div class="col-8">
                ...
                <input type="text" id="jurusan" class="text-light form-control <?= invalidFeedback('jurusan') ? 'is-invalid' : ''; ?>" name="jurusan" placeholder="Teknik Komputer dan Jaringan (TKJ)" , value="<?= old('jurusan'); ?>" required>
