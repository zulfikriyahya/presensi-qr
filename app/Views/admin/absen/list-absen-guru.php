         ...
         <tbody>
            ...
            <?php foreach ($data as $value) : ?>
               ...
               <tr>
                  ...
                  <td>
                     <?php if (!$lewat) : ?>
                        <button data-toggle="modal" data-target="#ubahModal" onclick="getDataKehadiran(<?= $value['id_presensi'] ?? '-1'; ?>, <?= $value['id_guru']; ?>)" class="btn btn-warning p-2" id="<?= $value['id_guru']; ?>">
